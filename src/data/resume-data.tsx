...
export const RESUME_DATA = {
  ...
  work: [
    {
      company: "У меня лапки (фриланс-проект)",
      link: "",
      badges: [],
    ...
    },
    {
      ...
      description: "Отправка и получение данных с сервера, отслеживание запросов, исправление ошибок в системе при сбоях на сервере. Контроль за обменом данными между местной системой и федеральным реестром.",
    },
    {
      company: "Cars7",
      link: "",
      badges: [],
      title: "Junior Flutter Developer (Найм на время разработки внутреннего сервиса)",
      logo: null,
      start: "Апрель 2024",
      end: "Май 2024",
