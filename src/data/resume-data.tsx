  ...
  projects: [
    {
      ...
      description: "Платформа для генерации изображений в едином минималистичном стиле с помощью AI. Может быть исапользована для стилизации ряда проектов: сайтов,  презентаций и т.п",
      logo: null,
      link: {
        label: "",
