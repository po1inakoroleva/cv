...
export const RESUME_DATA = {
  ...
  summary:
    "В настоящее время сфокусирована на освоении TypeScript. Стремлюсь к возможности применить свои знания и навыки на практике в рамках команды, где смогу внести свой вклад в общее дело.",
