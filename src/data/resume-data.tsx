  ...
  work: [
    {
      ...
      description: "Frontend разработка агрегатора проверенных благотворительных фондов и приютов для животных, цель которого — сделать доступным поиск организаций, помогающих животным, дав удобную платформу и гласность даже самым маленьким приютам в отдаленных уголках России.. Верстка по макету Figma, реализация взаимодецтсвия с сервером по API (REST).",
    },
    {
      company: "Cars7",
      link: "",
