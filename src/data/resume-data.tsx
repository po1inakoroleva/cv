...
export const RESUME_DATA = {
  ...
  summary:
    "В настоящее время занимаюсь благотворительной платформой помощи животным 'Help The Paws', являясь соавтором идеи проекта. Нахожусь в поиске работы Junior Frontend разработчиком.",
  ...
  work: [
    {
      ...
      description: "Агрегатор проверенных благотворительных фондов и приютов для животных. Цель проекта — сделать доступным поиск организаций, помогающих животным, дав удобную платформу и гласность даже самым маленьким приютам в отдаленных уголках России. Кроме того, платформа имеет просветительскую функцию с собранной информацией о том, как правильно и эффективно помогать таким организациям всеми возможными способами.",
    },
    {
      company: "Cars7",
      link: "",
